...
public class GrinderRecipe extends BaseRecipe {
	...
	public GrinderRecipe(ItemStack input1, ItemStack input2, FluidStack fluidStack, ItemStack output1,
	...
	public GrinderRecipe(ItemStack input1, ItemStack input2, FluidStack fluidStack, ItemStack output1,
		...
		this(input1, input2, fluidStack, output1, output2, output3, output4, tickTime, euPerTick);
