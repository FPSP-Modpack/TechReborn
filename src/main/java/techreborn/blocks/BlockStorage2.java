...
public class BlockStorage2 extends Block {
	...
	public static ItemStack getStorageBlockByName(String name, int count) {
		...
		if (meta == -1)
			throw new IllegalArgumentException("The storage block " + name + " could not be found!");
		return new ItemStack(ModBlocks.storage2, count, meta);
	}

	public static final String[] types = new String[] { "tungstensteel", "iridium_reinforced_tungstensteel",
			"iridium_reinforced_stone", "ruby", "sapphire", "peridot", "yellowGarnet", "redGarnet", "olivine" };
